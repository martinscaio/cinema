...
### Dados Georeferenciados 
 ...
 Os dados georeferenciados são basicamente dados espaciais que utilizam sua real localização no espaço geográfico. Essa localização é baseada em um par de coordenadas geográficas: latitude e longitude. 
...
Para isso irei utilizar os dados sobre cinema na cidade de São Paulo. Na página do Ancine há um banco de dados sobre as **salas de exibição e complexos de cinema credenciados pela Ancine**. Irei utilizar este banco de dados para o ano de 2019. A ideia será georeferenciar as salas de cinema/complexos para plotar um mapa com as suas localizações. 
...
Os dados foram retirados do site da [Ancine](http://dados.cultura.gov.br/dataset/salas-de-exibicao-e-complexos-credenciados-ancine)
